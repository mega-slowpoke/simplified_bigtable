...
var file_internal_tablet_proto_rawDesc = []byte{
	...
	0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0x95, 0x02, 0x0a, 0x15, 0x54, 0x61, 0x62, 0x6c, 0x65,
	...
	0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0d,
	0x5a, 0x0b, 0x66, 0x69, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70,
...
var file_internal_tablet_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_internal_tablet_proto_goTypes = []any{
	...
	(*CreateTableInternalRequest_ColumnFamily)(nil), // 6: bigtable.CreateTableInternalRequest.ColumnFamily
}
var file_internal_tablet_proto_depIdxs = []int32{
	6, // 0: bigtable.CreateTableInternalRequest.column_families:type_name -> bigtable.CreateTableInternalRequest.ColumnFamily
	...
	1, // 4: bigtable.TabletInternalService.CreateTable:output_type -> bigtable.CreateTableInternalResponse
	3, // 5: bigtable.TabletInternalService.DeleteTable:output_type -> bigtable.DeleteTableInternalResponse
	5, // 6: bigtable.TabletInternalService.Heartbeat:output_type -> bigtable.HeartbeatResponse
...
func file_internal_tablet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_tablet_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_internal_tablet_proto_msgTypes[6].Exporter = func(v any, i int) any {
